...
use crate::graphic3d_frame_stats_counter::FrameStatsCounter;
...
impl FrameStatsData {
    ...
    pub fn new() -> Self {
        FrameStatsData {
            counters: vec![0; 27], // FRAME_STATS_COUNTER_NB
...
impl Clone for FrameStatsData {
    fn clone(&self) -> Self {
        FrameStatsData {
            counters: self.counters.clone(),
            timers: self.timers.clone(),
            timers_min: self.timers_min.clone(),
            timers_max: self.timers_max.clone(),
            fps: self.fps,
            fps_cpu: self.fps_cpu,
            fps_immediate: self.fps_immediate,
            fps_cpu_immediate: self.fps_cpu_immediate,
        }
    }
}
