// FILE: step_ap214_h_array1_of_external_identification_item.rs
// occt: StepAP214_HArray1OfExternalIdentificationItem

use std::rc::Rc;
use std::cell::RefCell;

pub struct StepAP214HArray1OfExternalIdentificationItem {
...
impl StepAP214HArray1OfExternalIdentificationItem {
...
impl Clone for StepAP214HArray1OfExternalIdentificationItem {
    fn clone(&self) -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepAP214HArray1OfExternalIdentificationItem::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
    ...
    #[test]
    fn test_clone() {
        let arr1 = StepAP214HArray1OfExternalIdentificationItem::new(1, 3);
        arr1.set_value(2, 99);
        let arr2 = arr1.clone();
