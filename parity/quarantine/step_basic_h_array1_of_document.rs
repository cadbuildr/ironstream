// FILE: step_basic_h_array1_of_document.rs
// occt: StepBasic_HArray1OfDocument

use std::rc::Rc;
use std::cell::RefCell;

pub struct StepBasicHArray1OfDocument {
...
impl StepBasicHArray1OfDocument {
...
impl Clone for StepBasicHArray1OfDocument {
    fn clone(&self) -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicHArray1OfDocument::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
    ...
    #[test]
    fn test_clone() {
        let arr1 = StepBasicHArray1OfDocument::new(1, 3);
        arr1.set_value(2, 99);
        let arr2 = arr1.clone();
