// FILE: iges_appli_array1_of_flow.rs
// occt: IGESAppli_Array1OfFlow
...
impl Default for IGESAppliArray1OfFlow {
    fn default() -> Self {
        Self::new(1, 0)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new_array() {
        let arr = IGESAppliArray1OfFlow::new(1, 5);
    ...
    fn test_value_access() {
        let mut arr = IGESAppliArray1OfFlow::new(1, 3);
    ...
    fn test_set_value() {
        let mut arr = IGESAppliArray1OfFlow::new(1, 3);
        let elem = IGESAppliFlow { id: 50 };

        let result = arr.set_value(2, elem);
        assert!(result);

        let result_oob = arr.set_value(5, IGESAppliFlow { id: 100 });
        assert!(!result_oob);
    }
    ...
    fn test_iterator() {
        ...
        arr.set_value(3, IGESAppliFlow { id: 3 });
