// FILE: step_ap214_h_array1_of_auto_design_dated_item.rs
// occt: StepAP214_HArray1OfAutoDesignDatedItem

use std::rc::Rc;
use std::cell::RefCell;

pub struct StepAP214HArray1OfAutoDesignDatedItem {
...
impl StepAP214HArray1OfAutoDesignDatedItem {
...
impl Clone for StepAP214HArray1OfAutoDesignDatedItem {
    fn clone(&self) -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepAP214HArray1OfAutoDesignDatedItem::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
    ...
    #[test]
    fn test_clone() {
        let arr1 = StepAP214HArray1OfAutoDesignDatedItem::new(1, 3);
        arr1.set_value(2, 99);
        let arr2 = arr1.clone();
