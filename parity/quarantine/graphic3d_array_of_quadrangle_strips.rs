...
use crate::graphic3d_array_flags::{
    Graphic3dArrayFlags, GRAPHIC3D_ARRAY_FLAGS_BOUND_COLOR, GRAPHIC3D_ARRAY_FLAGS_NONE,
    GRAPHIC3D_ARRAY_FLAGS_VERTEX_COLOR, GRAPHIC3D_ARRAY_FLAGS_VERTEX_NORMAL,
