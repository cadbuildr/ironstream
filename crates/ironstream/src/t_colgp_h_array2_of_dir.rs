// FILE: t_colgp_h_array2_of_dir.rs
// occt: TColgp_HArray2OfDir
    ...
    pub fn new(row_lower: usize, row_upper: usize, col_lower: usize, col_upper: usize) -> Self {
        ...
        TColgpHArray2OfDir {
            data: Arc::new(Data {
                ...
                col_lower,
                col_upper,
                items: vec![Dir { x: 1.0, y: 0.0, z: 0.0 }; rows * cols],
            }),
        }
    }
...
mod tests {
    ...
    fn test_harray2_creation() {
        let arr = TColgpHArray2OfDir::new(1, 3, 1, 4);
    ...
    #[test]
    fn test_harray2_get() {
        let arr = TColgpHArray2OfDir::new(0, 2, 0, 2);
        let d = arr.get(1, 1);
        assert_eq!(d.x, 1.0);
    }
    ...
    fn test_harray2_clone() {
        let arr1 = TColgpHArray2OfDir::new(1, 2, 1, 2);
        let arr2 = arr1.clone();
