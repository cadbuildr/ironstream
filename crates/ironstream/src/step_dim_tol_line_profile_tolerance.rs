// FILE: step_dim_tol_line_profile_tolerance.rs
// occt: StepDimTol_LineProfileTolerance
...
mod tests {
    ...
    #[test]
    fn test_create() {
        let tol = LineProfileTolerance::new();
        assert!(tol.name.is_none());
    }

    #[test]
    fn test_set_and_get_name() {
        let mut tol = LineProfileTolerance::new();
        tol.set_name("line_profile".to_string());
        assert_eq!(tol.get_name(), Some("line_profile"));
    }

    #[test]
    fn test_set_magnitude() {
        let mut tol = LineProfileTolerance::new();
        tol.set_magnitude("1.5".to_string());
        assert_eq!(tol.get_magnitude(), Some("1.5"));
    }
}
