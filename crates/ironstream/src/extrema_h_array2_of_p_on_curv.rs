// FILE: extrema_h_array2_of_p_on_curv.rs
// occt: Extrema_HArray2OfPOnCurv
...
#[derive(Clone, Debug)]
pub struct HArray2OfPOnCurv {
    items: Vec<Vec<POnCurvHandle>>,
    lower1: usize,
    lower2: usize,
}
...
impl HArray2OfPOnCurv {
    pub fn new(lower1: usize, upper1: usize, lower2: usize, upper2: usize) -> Self {
        ...
        let default_handle = Rc::new(RefCell::new(POnCurv {}));
        HArray2OfPOnCurv {
...
mod tests {
    ...
    fn test_harray2_creation() {
        let arr = HArray2OfPOnCurv::new(1, 3, 1, 2);
