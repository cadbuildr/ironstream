// FILE: iges_data_array1_of_iges_entity.rs
// occt: IGESData_Array1OfIGESEntity
...
/// Array1 of IGESData_IGESEntity objects.
/// In OCCT, this was NCollection_Array1<opencascade::handle<IGESData_IGESEntity>>.
/// This Rust newtype wraps a Vec with 1-indexed access for faithful behavior.
pub struct IGESDataArray1OfIGESEntity {
    items: Vec<IGESDataIGESEntity>,
    lower: usize,
}

impl IGESDataArray1OfIGESEntity {
    /// Creates an array with a given lower bound and size.
    pub fn new(lower: usize, size: usize) -> Self {
        IGESDataArray1OfIGESEntity {
...
impl Default for IGESDataArray1OfIGESEntity {
    fn default() -> Self {
        Self::new(1, 0)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new_array() {
        let arr = IGESDataArray1OfIGESEntity::new(1, 5);
    ...
    fn test_value_access() {
        let mut arr = IGESDataArray1OfIGESEntity::new(1, 3);
    ...
    #[test]
    fn test_iterator() {
        let mut arr = IGESDataArray1OfIGESEntity::new(1, 2);
