// FILE: t_col_std_array2_of_transient.rs
// occt: TColStd_Array2OfTransient

/// TColStd_Array2OfTransient is a deprecated alias for a 2D 1-based array of transient objects.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdArray2OfTransient {
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdArray2OfTransient::new(1, 3, 1, 2);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColStdArray2OfTransient::new(1, 2, 1, 2);
    ...
    fn test_at_out_of_bounds() {
        let arr = TColStdArray2OfTransient::new(1, 2, 1, 2);
