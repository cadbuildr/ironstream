// FILE: step_fea_array1_of_curve_element_end_release.rs
// occt: StepFEA_Array1OfCurveElementEndRelease

/// Rust port of OCCT's deprecated StepFEA_Array1OfCurveElementEndRelease.
/// A 1-based fixed-length array wrapping a Vec, mimicking NCollection_Array1 semantics.
#[derive(Clone, Debug)]
pub struct StepFEAArray1OfCurveElementEndRelease {
    data: Vec<String>,
    lower: i32,
}

impl StepFEAArray1OfCurveElementEndRelease {
...
mod tests {
    ...
    fn test_array1_creation() {
        let arr = StepFEAArray1OfCurveElementEndRelease::new(1, 4);
    ...
    fn test_array1_access() {
        let mut arr = StepFEAArray1OfCurveElementEndRelease::new(1, 2);
    ...
    fn test_array1_from_vec() {
        ...
        let arr = StepFEAArray1OfCurveElementEndRelease::from_vec(1, values);
