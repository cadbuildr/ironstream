// FILE: step_ap214_array1_of_date_and_time_item.rs
// occt: StepAP214_Array1OfDateAndTimeItem

use std::cell::RefCell;

pub struct StepAP214Array1OfDateAndTimeItem {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepAP214Array1OfDateAndTimeItem {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepAP214Array1OfDateAndTimeItem::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
