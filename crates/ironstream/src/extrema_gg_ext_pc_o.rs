// FILE: extrema_gg_ext_pc_o.rs
// occt: Extrema_GGExtPC

/// Generic extrema solver for point-curve with gradient descent.
pub struct GGExtPC {
    done: bool,
    nb_ext: i32,
