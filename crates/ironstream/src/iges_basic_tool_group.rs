// FILE: iges_basic_tool_group.rs
// occt: IGESBasic_ToolGroup

/// Tool to work on a Group.
pub struct IgesBasicToolGroup;

impl IgesBasicToolGroup {
    pub fn new() -> Self {
        Self
    }
    ...
    pub fn own_dump(&self, ent: &str, _dumper: &str, _own: i32) -> String {
        format!("Group dump: {}", ent)
    }
}

impl Default for IgesBasicToolGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let tool = IgesBasicToolGroup::new();
        assert_eq!(tool.dir_checker("test"), "Group_DirChecker");
    }
}
