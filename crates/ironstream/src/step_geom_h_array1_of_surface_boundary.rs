// FILE: step_geom_h_array1_of_surface_boundary.rs
// occt: StepGeom_HArray1OfSurfaceBoundary

use std::vec::Vec;

pub struct StepGeomHArray1OfSurfaceBoundary {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepGeomHArray1OfSurfaceBoundary {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepGeomHArray1OfSurfaceBoundary::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
