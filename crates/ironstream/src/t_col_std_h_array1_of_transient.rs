// FILE: t_col_std_h_array1_of_transient.rs
// occt: TColStd_HArray1OfTransient

use std::ops::Index;

/// TColStd_HArray1OfTransient is a deprecated alias for a handle (heap-allocated) 1-based array of transient objects.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdHArray1OfTransient {
    data: Vec<Option<String>>,
    lower: i32,
    upper: i32,
}

impl TColStdHArray1OfTransient {
...
impl Index<i32> for TColStdHArray1OfTransient {
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdHArray1OfTransient::new(1, 5);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColStdHArray1OfTransient::new(1, 3);
    ...
    fn test_index_operator() {
        let mut arr = TColStdHArray1OfTransient::new(1, 2);
    ...
    fn test_out_of_bounds() {
        let arr = TColStdHArray1OfTransient::new(1, 3);
        let _ = arr[5];
    }
}
