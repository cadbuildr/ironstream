// FILE: step_shape_array1_of_oriented_edge.rs
// occt: StepShape_Array1OfOrientedEdge

use std::vec::Vec;

pub struct StepShapeArray1OfOrientedEdge {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeArray1OfOrientedEdge {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeArray1OfOrientedEdge::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
