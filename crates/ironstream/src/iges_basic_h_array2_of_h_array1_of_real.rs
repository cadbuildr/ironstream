// FILE: iges_basic_h_array2_of_h_array1_of_real.rs
// occt: IGESBasic_HArray2OfHArray1OfReal
...
/// Handle-based 2D Array of HArray1OfReal objects.
/// In OCCT, this was NCollection_HArray2<opencascade::handle<TColStd_HArray1OfReal>>.
/// This Rust newtype wraps a 2D Vec for faithful handle semantics.
pub struct IGESBasicHArray2OfHArray1OfReal {
    items: Vec<Vec<HArray1OfReal>>,
    row_lower: usize,
    col_lower: usize,
}

impl IGESBasicHArray2OfHArray1OfReal {
    ...
    pub fn new(row_lower: usize, row_size: usize, col_lower: usize, col_size: usize) -> Self {
        ...
        IGESBasicHArray2OfHArray1OfReal {
            items,
            row_lower,
            col_lower,
        }
...
impl Default for IGESBasicHArray2OfHArray1OfReal {
    fn default() -> Self {
        Self::new(1, 0, 1, 0)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new_array() {
        let arr = IGESBasicHArray2OfHArray1OfReal::new(1, 3, 1, 4);
    ...
    fn test_value_access() {
        let mut arr = IGESBasicHArray2OfHArray1OfReal::new(1, 2, 1, 3);
