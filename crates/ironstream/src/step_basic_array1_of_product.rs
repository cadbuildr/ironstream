// FILE: step_basic_array1_of_product.rs
// occt: StepBasic_Array1OfProduct

use std::cell::RefCell;

pub struct StepBasicArray1OfProduct {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepBasicArray1OfProduct {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicArray1OfProduct::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
