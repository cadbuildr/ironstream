// FILE: t_col_std_array2_of_integer.rs
// occt: TColStd_Array2OfInteger

/// TColStd_Array2OfInteger is a deprecated alias for a 2D 1-based array of integers.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdArray2OfInteger {
    data: Vec<i32>,
    row_lower: i32,
    row_upper: i32,
    col_lower: i32,
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdArray2OfInteger::new(1, 3, 1, 2);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColStdArray2OfInteger::new(1, 2, 1, 2);
        arr.set(1, 1, 10);
        arr.set(1, 2, 20);
        arr.set(2, 1, 30);
        arr.set(2, 2, 40);
    ...
    fn test_at_out_of_bounds() {
        let arr = TColStdArray2OfInteger::new(1, 2, 1, 2);
