// FILE: t_colgp_array2_of_dir2d.rs
// occt: TColgp_Array2OfDir2d
...
/// 2D array (matrix) of 2D direction vectors with bounds [row_lower..row_upper, col_lower..col_upper].
#[derive(Debug, Clone)]
pub struct TColgpArray2OfDir2d {
    row_lower: usize,
    row_upper: usize,
    col_lower: usize,
    col_upper: usize,
...
impl TColgpArray2OfDir2d {
    ...
    pub fn new(
        ...
        TColgpArray2OfDir2d {
            ...
            col_lower,
            col_upper,
            data: vec![Dir2d { x: 1.0, y: 0.0 }; rows * cols],
        }
    }
    ...
    pub fn set(&mut self, row: usize, col: usize, value: Dir2d) {
        if row < self.row_lower || row > self.row_upper || col < self.col_lower || col > self.col_upper {
            panic!(
                "Index ({}, {}) out of bounds [{},{}] x [{},{}]",
                row, col, self.row_lower, self.row_upper, self.col_lower, self.col_upper
    ...
    pub fn at(&self, row: usize, col: usize) -> &Dir2d {
        if row < self.row_lower || row > self.row_upper || col < self.col_lower || col > self.col_upper {
            panic!(
                "Index ({}, {}) out of bounds [{},{}] x [{},{}]",
                row, col, self.row_lower, self.row_upper, self.col_lower, self.col_upper
    ...
    pub fn at_mut(&mut self, row: usize, col: usize) -> &mut Dir2d {
        if row < self.row_lower || row > self.row_upper || col < self.col_lower || col > self.col_upper {
            panic!(
                "Index ({}, {}) out of bounds [{},{}] x [{},{}]",
                row, col, self.row_lower, self.row_upper, self.col_lower, self.col_upper
...
mod tests {
    ...
    fn test_array2_creation() {
        let arr = TColgpArray2OfDir2d::new(1, 3, 1, 4);
    ...
    fn test_array2_set_and_get() {
        let mut arr = TColgpArray2OfDir2d::new(0, 2, 0, 2);
    ...
    fn test_array2_at_mutable() {
        let mut arr = TColgpArray2OfDir2d::new(1, 2, 1, 2);
        {
    ...
    fn test_array2_get_out_of_bounds() {
        let arr = TColgpArray2OfDir2d::new(1, 2, 1, 2);
        let _ = arr.get(3, 1);
    }
}
