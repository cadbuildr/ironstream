// FILE: expr_array1_of_single_relation.rs
// occt: Expr_Array1OfSingleRelation

/// Deprecated typedef for backward compatibility.
/// A 1D array of SingleRelation handles, implemented as a Vec.
pub struct ExprArray1OfSingleRelation {
    data: Vec<String>,
    lower: usize,
}

impl ExprArray1OfSingleRelation {
...
mod tests {
    ...
    fn test_create_array() {
        let arr = ExprArray1OfSingleRelation::new(1, 5);
    ...
    fn test_value_access() {
        let mut arr = ExprArray1OfSingleRelation::new(1, 3);
        arr.set_value(1, "rel1");
        arr.set_value(2, "rel2");
        arr.set_value(3, "rel3");
        assert_eq!(arr.value(1), Some("rel1"));
        assert_eq!(arr.value(2), Some("rel2"));
        assert_eq!(arr.value(3), Some("rel3"));
    ...
    fn test_zero_based_array() {
        let arr = ExprArray1OfSingleRelation::new(0, 2);
    ...
    #[test]
    fn test_empty_array() {
        let arr = ExprArray1OfSingleRelation::new(5, 4);
        assert_eq!(arr.length(), 0);
    }

    #[test]
    fn test_set_and_get() {
        let mut arr = ExprArray1OfSingleRelation::new(10, 12);
        arr.set_value(10, "a");
        arr.set_value(11, "b");
        arr.set_value(12, "c");
