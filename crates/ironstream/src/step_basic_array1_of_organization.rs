// FILE: step_basic_array1_of_organization.rs
// occt: StepBasic_Array1OfOrganization

use std::cell::RefCell;

pub struct StepBasicArray1OfOrganization {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepBasicArray1OfOrganization {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicArray1OfOrganization::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
