// FILE: t_colgp_h_array2_of_xy.rs
// occt: TColgp_HArray2OfXY
    ...
    pub fn new(row_lower: usize, row_upper: usize, col_lower: usize, col_upper: usize) -> Self {
        ...
        TColgpHArray2OfXY {
            data: Arc::new(Data {
                ...
                items: vec![XY { x: 0.0, y: 0.0 }; rows * cols],
            }),
        }
    }
...
mod tests {
    use super::*;
    #[test]
    fn test_creation() { let _arr = TColgpHArray2OfXY::new(1, 2, 1, 2); }
}
