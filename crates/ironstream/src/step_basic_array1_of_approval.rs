// FILE: step_basic_array1_of_approval.rs
// occt: StepBasic_Array1OfApproval

use std::cell::RefCell;

pub struct StepBasicArray1OfApproval {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepBasicArray1OfApproval {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicArray1OfApproval::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
