// FILE: step_shape_array1_of_connected_face_set.rs
// occt: StepShape_Array1OfConnectedFaceSet

use std::vec::Vec;

pub struct StepShapeArray1OfConnectedFaceSet {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeArray1OfConnectedFaceSet {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeArray1OfConnectedFaceSet::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
