...
impl BRepFillNSections {
    ...
    /// Analyze shapes: constancy and vertex-ness are properties of the section
    /// data itself, independent of whether the surface has been built.
    fn analyze_sections(&mut self) {
    ...
    /// Internal build: prepare interpolation data.
    /// Full implementation would set up the B-spline surface.
