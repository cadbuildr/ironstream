// FILE: t_col_std_sequence_of_ascii_string.rs
// occt: TColStd_SequenceOfAsciiString

/// TColStd_SequenceOfAsciiString is a deprecated alias for a sequence of ASCII strings.
/// This is a Rust port implementing OCCT's sequence semantics (1-based indexing).
pub struct TColStdSequenceOfAsciiString {
    data: Vec<String>,
}

impl TColStdSequenceOfAsciiString {
    /// Creates a new empty sequence.
    pub fn new() -> Self {
        TColStdSequenceOfAsciiString {
            data: Vec::new(),
        }
    }
...
impl Default for TColStdSequenceOfAsciiString {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn test_append_and_length() {
        let mut seq = TColStdSequenceOfAsciiString::new();
