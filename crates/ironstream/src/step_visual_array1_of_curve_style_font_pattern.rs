// FILE: step_visual_array1_of_curve_style_font_pattern.rs
// occt: StepVisual_Array1OfCurveStyleFontPattern

/// StepVisual_Array1OfCurveStyleFontPattern: a 1-based array.
///
...
impl StepVisual_Array1OfCurveStyleFontPattern {
...
mod tests {
    ...
    fn test_array1_bounds() {
        let arr = StepVisual_Array1OfCurveStyleFontPattern::new(1, 10);
    ...
    fn test_array1_set_and_get() {
        let mut arr = StepVisual_Array1OfCurveStyleFontPattern::new(1, 5);
        arr.set(1, 99);
        arr.set(5, 42);
    ...
    #[test]
    fn test_array1_fill() {
        let mut arr = StepVisual_Array1OfCurveStyleFontPattern::new(1, 3);
        arr.fill(77);
