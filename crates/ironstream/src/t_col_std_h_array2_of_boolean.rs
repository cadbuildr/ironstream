// FILE: t_col_std_h_array2_of_boolean.rs
// occt: TColStd_HArray2OfBoolean

/// TColStd_HArray2OfBoolean is a deprecated alias for a handle (heap-allocated) 2D 1-based array of booleans.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdHArray2OfBoolean {
    data: Vec<bool>,
    row_lower: i32,
    row_upper: i32,
    col_lower: i32,
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdHArray2OfBoolean::new(1, 3, 1, 2);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColStdHArray2OfBoolean::new(1, 2, 1, 2);
        arr.set(1, 1, true);
        arr.set(1, 2, false);
        arr.set(2, 1, false);
        arr.set(2, 2, true);
    ...
    fn test_at_out_of_bounds() {
        let arr = TColStdHArray2OfBoolean::new(1, 2, 1, 2);
