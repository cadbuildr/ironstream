// FILE: step_repr_h_array1_of_property_definition_representation.rs
// occt: StepRepr_HArray1OfPropertyDefinitionRepresentation

use std::vec::Vec;

pub struct StepReprHArray1OfPropertyDefinitionRepresentation {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepReprHArray1OfPropertyDefinitionRepresentation {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepReprHArray1OfPropertyDefinitionRepresentation::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
