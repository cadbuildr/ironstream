// FILE: step_visual_h_array1_of_invisible_item.rs
// occt: StepVisual_HArray1OfInvisibleItem

use std::sync::Arc;

#[derive(Debug, Clone)]
pub struct StepVisualArray1InvisibleItem {
    lower: i32,
    upper: i32,
    data: Vec<u64>,
}

impl StepVisualArray1InvisibleItem {
...
pub type StepVisual_HArray1OfInvisibleItem = Arc<StepVisualArray1InvisibleItem>;
...
mod tests {
    ...
    fn test_harray1_bounds() {
        let arr = Arc::new(StepVisualArray1InvisibleItem::new(1, 5));
    ...
    fn test_harray1_shared() {
        let arr1 = Arc::new(StepVisualArray1InvisibleItem::new(1, 3));
