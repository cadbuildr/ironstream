// FILE: step_shape_array1_of_oriented_closed_shell.rs
// occt: StepShape_Array1OfOrientedClosedShell

use std::vec::Vec;

pub struct StepShapeArray1OfOrientedClosedShell {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeArray1OfOrientedClosedShell {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeArray1OfOrientedClosedShell::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
