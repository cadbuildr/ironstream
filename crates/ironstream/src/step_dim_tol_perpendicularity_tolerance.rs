// FILE: step_dim_tol_perpendicularity_tolerance.rs
// occt: StepDimTol_PerpendicularityTolerance
...
mod tests {
    ...
    #[test]
    fn test_create() {
        let tol = PerpendicularityTolerance::new();
        assert!(tol.name.is_none());
    }

    #[test]
    fn test_set_and_get_name() {
        let mut tol = PerpendicularityTolerance::new();
        tol.set_name("perpendicular".to_string());
        assert_eq!(tol.get_name(), Some("perpendicular"));
    }

    #[test]
    fn test_set_magnitude() {
        let mut tol = PerpendicularityTolerance::new();
        tol.set_magnitude("1.0".to_string());
        assert_eq!(tol.get_magnitude(), Some("1.0"));
    }
}
