// FILE: t_col_std_array2_of_character.rs
// occt: TColStd_Array2OfCharacter

/// TColStd_Array2OfCharacter is a deprecated alias for a 2D 1-based array of characters.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdArray2OfCharacter {
    data: Vec<char>,
    row_lower: i32,
    row_upper: i32,
    col_lower: i32,
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdArray2OfCharacter::new(1, 3, 1, 2);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColStdArray2OfCharacter::new(1, 2, 1, 2);
        arr.set(1, 1, 'a');
        arr.set(1, 2, 'b');
        arr.set(2, 1, 'c');
        arr.set(2, 2, 'd');
    ...
    fn test_at_out_of_bounds() {
        let arr = TColStdArray2OfCharacter::new(1, 2, 1, 2);
