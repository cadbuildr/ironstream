// FILE: t_col_geom2d_h_array1_of_b_spline_curve.rs
// occt: TColGeom2d_HArray1OfBSplineCurve

use std::sync::Arc;

#[derive(Debug, Clone)]
pub struct TColGeom2dArray1BSplineCurve {
    lower: i32,
    upper: i32,
    data: Vec<u64>,
}

impl TColGeom2dArray1BSplineCurve {
...
pub type TColGeom2d_HArray1OfBSplineCurve = Arc<TColGeom2dArray1BSplineCurve>;
...
mod tests {
    ...
    fn test_harray_bounds() {
        let arr = Arc::new(TColGeom2dArray1BSplineCurve::new(1, 5));
    ...
    fn test_harray_shared() {
        let arr1 = Arc::new(TColGeom2dArray1BSplineCurve::new(1, 3));
