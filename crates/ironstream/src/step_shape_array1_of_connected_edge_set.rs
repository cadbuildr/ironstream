// FILE: step_shape_array1_of_connected_edge_set.rs
// occt: StepShape_Array1OfConnectedEdgeSet

use std::vec::Vec;

pub struct StepShapeArray1OfConnectedEdgeSet {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeArray1OfConnectedEdgeSet {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeArray1OfConnectedEdgeSet::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
