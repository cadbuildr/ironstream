// FILE: step_basic_array1_of_derived_unit_element.rs
// occt: StepBasic_Array1OfDerivedUnitElement

use std::cell::RefCell;

pub struct StepBasicArray1OfDerivedUnitElement {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepBasicArray1OfDerivedUnitElement {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicArray1OfDerivedUnitElement::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
