// FILE: step_basic_array1_of_document.rs
// occt: StepBasic_Array1OfDocument

use std::cell::RefCell;

pub struct StepBasicArray1OfDocument {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepBasicArray1OfDocument {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicArray1OfDocument::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
