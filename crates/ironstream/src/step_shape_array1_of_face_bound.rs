// FILE: step_shape_array1_of_face_bound.rs
// occt: StepShape_Array1OfFaceBound

use std::vec::Vec;

pub struct StepShapeArray1OfFaceBound {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeArray1OfFaceBound {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeArray1OfFaceBound::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
