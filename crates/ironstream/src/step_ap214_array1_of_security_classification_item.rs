// FILE: step_ap214_array1_of_security_classification_item.rs
// occt: StepAP214_Array1OfSecurityClassificationItem

use std::cell::RefCell;

pub struct StepAP214Array1OfSecurityClassificationItem {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepAP214Array1OfSecurityClassificationItem {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepAP214Array1OfSecurityClassificationItem::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
