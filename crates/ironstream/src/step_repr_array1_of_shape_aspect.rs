// FILE: step_repr_array1_of_shape_aspect.rs
// occt: StepRepr_Array1OfShapeAspect

use std::vec::Vec;

pub struct StepReprArray1OfShapeAspect {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepReprArray1OfShapeAspect {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepReprArray1OfShapeAspect::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
