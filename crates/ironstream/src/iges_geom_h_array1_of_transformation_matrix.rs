// FILE: iges_geom_h_array1_of_transformation_matrix.rs
// occt: IGESGeom_HArray1OfTransformationMatrix
...
/// Handle-based Array1 of IGESGeom_TransformationMatrix objects.
/// In OCCT, this was NCollection_HArray1<opencascade::handle<IGESGeom_TransformationMatrix>>.
/// This Rust newtype wraps a Vec with 1-indexed access for faithful handle semantics.
pub struct IGESGeomHArray1OfTransformationMatrix {
    items: Vec<IGESGeomTransformationMatrix>,
    lower: usize,
}

impl IGESGeomHArray1OfTransformationMatrix {
...
impl Default for IGESGeomHArray1OfTransformationMatrix {
    fn default() -> Self {
        Self::new(1, 0)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new_array() {
        let arr = IGESGeomHArray1OfTransformationMatrix::new(1, 5);
    ...
    fn test_value_access() {
        let mut arr = IGESGeomHArray1OfTransformationMatrix::new(1, 3);
    ...
    #[test]
    fn test_iterator() {
        let mut arr = IGESGeomHArray1OfTransformationMatrix::new(1, 2);
