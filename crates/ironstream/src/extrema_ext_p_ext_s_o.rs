// FILE: extrema_ext_p_ext_s_o.rs
// occt: Extrema_ExtPExtS

/// Extrema calculator for point and surface of extrusion.
pub struct ExtPExtS {
    done: bool,
    nb_ext: i32,
