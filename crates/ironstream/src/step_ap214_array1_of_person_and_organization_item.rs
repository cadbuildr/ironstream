// FILE: step_ap214_array1_of_person_and_organization_item.rs
// occt: StepAP214_Array1OfPersonAndOrganizationItem

use std::cell::RefCell;

pub struct StepAP214Array1OfPersonAndOrganizationItem {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepAP214Array1OfPersonAndOrganizationItem {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepAP214Array1OfPersonAndOrganizationItem::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
