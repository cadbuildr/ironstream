// FILE: step_repr_array1_of_material_property_representation.rs
// occt: StepRepr_Array1OfMaterialPropertyRepresentation

use std::vec::Vec;

pub struct StepReprArray1OfMaterialPropertyRepresentation {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepReprArray1OfMaterialPropertyRepresentation {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepReprArray1OfMaterialPropertyRepresentation::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
