// FILE: step_shape_h_array1_of_face.rs
// occt: StepShape_HArray1OfFace

use std::vec::Vec;

pub struct StepShapeHArray1OfFace {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeHArray1OfFace {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeHArray1OfFace::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
