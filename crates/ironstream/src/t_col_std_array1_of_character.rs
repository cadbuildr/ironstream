// FILE: t_col_std_array1_of_character.rs
// occt: TColStd_Array1OfCharacter

use std::ops::Index;

/// TColStd_Array1OfCharacter is a deprecated alias for a 1-based array of characters.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdArray1OfCharacter {
    data: Vec<char>,
    lower: i32,
    upper: i32,
}

impl TColStdArray1OfCharacter {
...
impl Index<i32> for TColStdArray1OfCharacter {
    type Output = char;
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdArray1OfCharacter::new(1, 5);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColStdArray1OfCharacter::new(1, 3);
        arr.set(1, 'a');
        arr.set(2, 'b');
        arr.set(3, 'c');
    ...
    fn test_index_operator() {
        let mut arr = TColStdArray1OfCharacter::new(1, 2);
        arr.set(1, 'x');
        assert_eq!(arr[1], 'x');
    }
    ...
    fn test_out_of_bounds() {
        let arr = TColStdArray1OfCharacter::new(1, 3);
        let _ = arr[5];
    }
}
