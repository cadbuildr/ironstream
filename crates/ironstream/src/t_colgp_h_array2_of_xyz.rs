// FILE: t_colgp_h_array2_of_xyz.rs
// occt: TColgp_HArray2OfXYZ
    ...
    pub fn new(row_lower: usize, row_upper: usize, col_lower: usize, col_upper: usize) -> Self {
        ...
        TColgpHArray2OfXYZ {
            data: Arc::new(Data {
                ...
                items: vec![XYZ { x: 0.0, y: 0.0, z: 0.0 }; rows * cols],
            }),
        }
    }
...
mod tests {
    use super::*;
    #[test]
    fn test_creation() { let _arr = TColgpHArray2OfXYZ::new(1, 2, 1, 2); }
}
