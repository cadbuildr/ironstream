// FILE: step_shape_h_array1_of_oriented_edge.rs
// occt: StepShape_HArray1OfOrientedEdge

use std::vec::Vec;

pub struct StepShapeHArray1OfOrientedEdge {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeHArray1OfOrientedEdge {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeHArray1OfOrientedEdge::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
