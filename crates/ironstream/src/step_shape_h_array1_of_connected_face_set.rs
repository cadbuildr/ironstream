// FILE: step_shape_h_array1_of_connected_face_set.rs
// occt: StepShape_HArray1OfConnectedFaceSet

use std::vec::Vec;

pub struct StepShapeHArray1OfConnectedFaceSet {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeHArray1OfConnectedFaceSet {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeHArray1OfConnectedFaceSet::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
