// FILE: iges_geom_array1_of_curve_on_surface.rs
// occt: IGESGeom_Array1OfCurveOnSurface
...
/// Array1 of IGESGeom_CurveOnSurface objects.
/// In OCCT, this was NCollection_Array1<opencascade::handle<IGESGeom_CurveOnSurface>>.
/// This Rust newtype wraps a Vec with 1-indexed access for faithful behavior.
pub struct IGESGeomArray1OfCurveOnSurface {
    items: Vec<IGESGeomCurveOnSurface>,
    lower: usize,
}

impl IGESGeomArray1OfCurveOnSurface {
    /// Creates an array with a given lower bound and size.
    pub fn new(lower: usize, size: usize) -> Self {
        IGESGeomArray1OfCurveOnSurface {
...
impl Default for IGESGeomArray1OfCurveOnSurface {
    fn default() -> Self {
        Self::new(1, 0)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new_array() {
        let arr = IGESGeomArray1OfCurveOnSurface::new(1, 5);
    ...
    fn test_value_access() {
        let mut arr = IGESGeomArray1OfCurveOnSurface::new(1, 3);
    ...
    #[test]
    fn test_iterator() {
        let mut arr = IGESGeomArray1OfCurveOnSurface::new(1, 2);
