// FILE: step_repr_array1_of_representation_item.rs
// occt: StepRepr_Array1OfRepresentationItem

use std::vec::Vec;

pub struct StepReprArray1OfRepresentationItem {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepReprArray1OfRepresentationItem {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepReprArray1OfRepresentationItem::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
