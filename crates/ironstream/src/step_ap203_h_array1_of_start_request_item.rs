// FILE: step_ap203_h_array1_of_start_request_item.rs
// occt: StepAP203_HArray1OfStartRequestItem

use std::rc::Rc;
use std::cell::RefCell;

/// Deprecated newtype: a reference-counted handle to a 1-based Array1 of StepAP203_StartRequestItem.
/// Mirrors OCCT NCollection_HArray1<StepAP203_StartRequestItem>.
/// Uses Lower/Upper bounds (1-based indexing by default, like OCCT Array1).
pub struct StepAP203HArray1OfStartRequestItem {
    inner: Rc<RefCell<HArray1Inner>>,
}

struct HArray1Inner {
    data: Vec<i32>, // Placeholder for StepAP203_StartRequestItem
    lower: usize,
    upper: usize,
}

impl StepAP203HArray1OfStartRequestItem {
...
impl Clone for StepAP203HArray1OfStartRequestItem {
    fn clone(&self) -> Self {
        Self {
...
mod tests {
    ...
    fn test_harray1_create() {
        let arr = StepAP203HArray1OfStartRequestItem::new(1, 10);
    ...
    fn test_harray1_bounds() {
        let arr = StepAP203HArray1OfStartRequestItem::new(5, 15);
    ...
    fn test_harray1_get_set() {
        let arr = StepAP203HArray1OfStartRequestItem::new(1, 5);
        arr.set_value(1, 100);
        arr.set_value(3, 200);
        arr.set_value(5, 300);
    ...
    fn test_harray1_clone_shares_data() {
        let arr1 = StepAP203HArray1OfStartRequestItem::new(1, 3);
        arr1.set_value(2, 42);
    ...
    fn test_harray1_panic_lower() {
        let arr = StepAP203HArray1OfStartRequestItem::new(5, 10);
