// FILE: step_fea_h_array1_of_degree_of_freedom.rs
// occt: StepFEA_HArray1OfDegreeOfFreedom

/// Rust port of OCCT's deprecated StepFEA_HArray1OfDegreeOfFreedom.
/// HArray1 is a heap-allocated wrapper. A 1-based fixed-length array wrapping a Vec.
#[derive(Clone, Debug)]
pub struct StepFEAHArray1OfDegreeOfFreedom {
    data: Vec<i32>,
    lower: i32,
}

impl StepFEAHArray1OfDegreeOfFreedom {
...
mod tests {
    ...
    fn test_harray1_creation() {
        let arr = StepFEAHArray1OfDegreeOfFreedom::new(1, 6);
    ...
    fn test_harray1_set_get() {
        let mut arr = StepFEAHArray1OfDegreeOfFreedom::new(1, 3);
        arr.set_value(1, 1);
        arr.set_value(2, 2);
        arr.set_value(3, 3);
    ...
    fn test_harray1_from_vec() {
        ...
        let arr = StepFEAHArray1OfDegreeOfFreedom::from_vec(1, values);
