// FILE: step_basic_array1_of_named_unit.rs
// occt: StepBasic_Array1OfNamedUnit

use std::cell::RefCell;

pub struct StepBasicArray1OfNamedUnit {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepBasicArray1OfNamedUnit {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicArray1OfNamedUnit::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
