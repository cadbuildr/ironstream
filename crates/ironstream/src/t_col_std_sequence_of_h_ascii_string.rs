// FILE: t_col_std_sequence_of_h_ascii_string.rs
// occt: TColStd_SequenceOfHAsciiString

/// TColStd_SequenceOfHAsciiString is a deprecated alias for a sequence of handle ASCII strings.
/// This is a Rust port implementing OCCT's sequence semantics (1-based indexing).
pub struct TColStdSequenceOfHAsciiString {
    data: Vec<Option<String>>,
}

impl TColStdSequenceOfHAsciiString {
    /// Creates a new empty sequence.
    pub fn new() -> Self {
        TColStdSequenceOfHAsciiString {
            data: Vec::new(),
        }
    }
...
impl Default for TColStdSequenceOfHAsciiString {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn test_append_and_length() {
        let mut seq = TColStdSequenceOfHAsciiString::new();
        assert_eq!(seq.length(), 0);

        seq.append(Some("hello".to_string()));
        seq.append(None);
