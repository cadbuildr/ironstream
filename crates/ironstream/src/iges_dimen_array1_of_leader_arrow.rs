// FILE: iges_dimen_array1_of_leader_arrow.rs
// occt: IGESDimen_Array1OfLeaderArrow
...
/// Array1 of IGESDimen_LeaderArrow objects.
/// In OCCT, this was NCollection_Array1<opencascade::handle<IGESDimen_LeaderArrow>>.
/// This Rust newtype wraps a Vec with 1-indexed access for faithful behavior.
pub struct IGESDimenArray1OfLeaderArrow {
    items: Vec<IGESDimenLeaderArrow>,
    lower: usize,
}

impl IGESDimenArray1OfLeaderArrow {
    /// Creates an array with a given lower bound and size.
    pub fn new(lower: usize, size: usize) -> Self {
        IGESDimenArray1OfLeaderArrow {
...
impl Default for IGESDimenArray1OfLeaderArrow {
    fn default() -> Self {
        Self::new(1, 0)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new_array() {
        let arr = IGESDimenArray1OfLeaderArrow::new(1, 5);
    ...
    fn test_value_access() {
        let mut arr = IGESDimenArray1OfLeaderArrow::new(1, 3);
    ...
    #[test]
    fn test_iterator() {
        let mut arr = IGESDimenArray1OfLeaderArrow::new(1, 2);
