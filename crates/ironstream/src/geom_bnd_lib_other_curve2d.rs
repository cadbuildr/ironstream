// FILE: geom_bnd_lib_other_curve2d.rs
// occt: GeomBndLib_OtherCurve2d

/// Computes bounding box for a OtherCurve2d.
pub struct OtherCurve2d {
    data: [f64; 9],
}

impl OtherCurve2d {
    pub fn new(_curve: &[f64; 9]) -> Self {
        OtherCurve2d { data: *_curve }
    }
...
mod tests {
    ...
    #[test]
    fn test_other_curve2d_new() {
        let data = [0.0; 9];
        let obj = OtherCurve2d::new(&data);
