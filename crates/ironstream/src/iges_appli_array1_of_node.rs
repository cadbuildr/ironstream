// FILE: iges_appli_array1_of_node.rs
// occt: IGESAppli_Array1OfNode
...
impl Default for IGESAppliArray1OfNode {
    fn default() -> Self {
        Self::new(1, 0)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new_array() {
        let arr = IGESAppliArray1OfNode::new(1, 5);
    ...
    fn test_value_access() {
        let mut arr = IGESAppliArray1OfNode::new(1, 3);
    ...
    fn test_set_value() {
        let mut arr = IGESAppliArray1OfNode::new(1, 3);
        let elem = IGESAppliNode { id: 50 };

        let result = arr.set_value(2, elem);
        assert!(result);

        let result_oob = arr.set_value(5, IGESAppliNode { id: 100 });
        assert!(!result_oob);
    }
    ...
    fn test_iterator() {
        ...
        arr.set_value(3, IGESAppliNode { id: 3 });
