// FILE: step_fea_h_array1_of_curve_element_end_offset.rs
// occt: StepFEA_HArray1OfCurveElementEndOffset

/// Rust port of OCCT's deprecated StepFEA_HArray1OfCurveElementEndOffset.
/// HArray1 is a heap-allocated wrapper. A 1-based fixed-length array wrapping a Vec.
#[derive(Clone, Debug)]
pub struct StepFEAHArray1OfCurveElementEndOffset {
    data: Vec<String>,
    lower: i32,
}

impl StepFEAHArray1OfCurveElementEndOffset {
...
mod tests {
    ...
    fn test_harray1_creation() {
        let arr = StepFEAHArray1OfCurveElementEndOffset::new(1, 5);
    ...
    fn test_harray1_access() {
        let mut arr = StepFEAHArray1OfCurveElementEndOffset::new(1, 2);
    ...
    fn test_harray1_from_vec() {
        ...
        let arr = StepFEAHArray1OfCurveElementEndOffset::from_vec(1, values);
