// FILE: t_col_geom2d_h_array1_of_curve.rs
// occt: TColGeom2d_HArray1OfCurve

use std::sync::Arc;

#[derive(Debug, Clone)]
pub struct TColGeom2dArray1Curve {
    lower: i32,
    upper: i32,
    data: Vec<u64>,
}

impl TColGeom2dArray1Curve {
...
pub type TColGeom2d_HArray1OfCurve = Arc<TColGeom2dArray1Curve>;
...
mod tests {
    ...
    fn test_harray_bounds() {
        let arr = Arc::new(TColGeom2dArray1Curve::new(1, 5));
    ...
    fn test_harray_shared() {
        let arr1 = Arc::new(TColGeom2dArray1Curve::new(1, 3));
