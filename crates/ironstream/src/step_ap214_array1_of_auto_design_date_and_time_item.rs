// FILE: step_ap214_array1_of_auto_design_date_and_time_item.rs
// occt: StepAP214_Array1OfAutoDesignDateAndTimeItem

use std::cell::RefCell;

/// Deprecated newtype: a 1-based Array1 of StepAP214_AutoDesignDateAndTimeItem.
pub struct StepAP214Array1OfAutoDesignDateAndTimeItem {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepAP214Array1OfAutoDesignDateAndTimeItem {
...
mod tests {
    ...
    fn test_array1_create() {
        let arr = StepAP214Array1OfAutoDesignDateAndTimeItem::new(1, 10);
    ...
    fn test_array1_get_set() {
        let arr = StepAP214Array1OfAutoDesignDateAndTimeItem::new(1, 5);
        arr.set_value(1, 100);
