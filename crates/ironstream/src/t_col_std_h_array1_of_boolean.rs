// FILE: t_col_std_h_array1_of_boolean.rs
// occt: TColStd_HArray1OfBoolean

use std::ops::Index;

/// TColStd_HArray1OfBoolean is a deprecated alias for a handle (heap-allocated) 1-based array of booleans.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdHArray1OfBoolean {
    data: Vec<bool>,
    lower: i32,
    upper: i32,
}

impl TColStdHArray1OfBoolean {
...
impl Index<i32> for TColStdHArray1OfBoolean {
    type Output = bool;
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdHArray1OfBoolean::new(1, 5);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColStdHArray1OfBoolean::new(1, 3);
        arr.set(1, true);
        arr.set(2, false);
        arr.set(3, true);
    ...
    fn test_index_operator() {
        let mut arr = TColStdHArray1OfBoolean::new(1, 2);
        arr.set(1, true);
    ...
    fn test_out_of_bounds() {
        let arr = TColStdHArray1OfBoolean::new(1, 3);
        let _ = arr[5];
    }
}
