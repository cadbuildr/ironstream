// FILE: iges_basic_tool_name.rs
// occt: IGESBasic_ToolName

/// Tool to work on a Name.
pub struct IgesBasicToolName;

impl IgesBasicToolName {
    pub fn new() -> Self {
        Self
    }
    ...
    pub fn own_dump(&self, ent: &str, _dumper: &str, _own: i32) -> String {
        format!("Name dump: {}", ent)
    }
}

impl Default for IgesBasicToolName {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let tool = IgesBasicToolName::new();
        assert_eq!(tool.dir_checker("test"), "Name_DirChecker");
    }
}
