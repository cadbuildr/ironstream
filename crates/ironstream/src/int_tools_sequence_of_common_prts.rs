// FILE: int_tools_sequence_of_common_prts.rs
// occt: IntTools_SequenceOfCommonPrts

/// Deprecated alias for NCollection_Sequence<IntTools_CommonPrt>.
/// Maintains backward compatibility. Use Vec directly in new code.
pub struct IntToolsSequenceOfCommonPrts {
    items: Vec<u32>, // Placeholder for IntTools_CommonPrt (opaque type)
}

impl IntToolsSequenceOfCommonPrts {
    pub fn new() -> Self {
        Self {
            items: Vec::new(),
        }
...
impl Default for IntToolsSequenceOfCommonPrts {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn test_sequence_append() {
        let mut seq = IntToolsSequenceOfCommonPrts::new();
        assert!(seq.is_empty());
    ...
    #[test]
    fn test_default() {
        let seq = IntToolsSequenceOfCommonPrts::default();
        assert!(seq.is_empty());
    }
}
