// FILE: step_visual_h_array1_of_layered_item.rs
// occt: StepVisual_HArray1OfLayeredItem

use std::sync::Arc;

#[derive(Debug, Clone)]
pub struct StepVisualArray1LayeredItem {
    lower: i32,
    upper: i32,
    data: Vec<u64>,
}

impl StepVisualArray1LayeredItem {
...
pub type StepVisual_HArray1OfLayeredItem = Arc<StepVisualArray1LayeredItem>;
...
mod tests {
    ...
    fn test_harray1_bounds() {
        let arr = Arc::new(StepVisualArray1LayeredItem::new(1, 5));
    ...
    fn test_harray1_shared() {
        let arr1 = Arc::new(StepVisualArray1LayeredItem::new(1, 3));
