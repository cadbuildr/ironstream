// FILE: t_col_std_array1_of_list_of_integer.rs
// occt: TColStd_Array1OfListOfInteger

use std::ops::Index;

/// TColStd_Array1OfListOfInteger is a deprecated alias for a 1-based array of integer lists.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdArray1OfListOfInteger {
    data: Vec<Vec<i32>>,
    lower: i32,
    upper: i32,
}

impl TColStdArray1OfListOfInteger {
...
impl Index<i32> for TColStdArray1OfListOfInteger {
    type Output = Vec<i32>;
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdArray1OfListOfInteger::new(1, 5);
    ...
    fn test_append_to_list() {
        let mut arr = TColStdArray1OfListOfInteger::new(1, 2);
    ...
    fn test_index_operator() {
        let mut arr = TColStdArray1OfListOfInteger::new(1, 1);
    ...
    fn test_out_of_bounds() {
        let arr = TColStdArray1OfListOfInteger::new(1, 3);
        let _ = arr[5];
    }
}
