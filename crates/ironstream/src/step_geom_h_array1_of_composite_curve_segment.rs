// FILE: step_geom_h_array1_of_composite_curve_segment.rs
// occt: StepGeom_HArray1OfCompositeCurveSegment

use std::vec::Vec;

pub struct StepGeomHArray1OfCompositeCurveSegment {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepGeomHArray1OfCompositeCurveSegment {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepGeomHArray1OfCompositeCurveSegment::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
