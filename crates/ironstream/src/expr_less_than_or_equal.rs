// FILE: expr_less_than_or_equal.rs
// occt: Expr_LessThanOrEqual

#[derive(Debug, Clone)]
pub struct ExprLessThanOrEqual {
    first: String,
    second: String,
}

impl ExprLessThanOrEqual {
...
mod tests {
    use super::*;
    #[test]
    fn test() { assert!(ExprLessThanOrEqual::new("5", "5").is_satisfied()); }
}
