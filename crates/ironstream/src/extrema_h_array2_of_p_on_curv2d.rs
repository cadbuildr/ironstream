// FILE: extrema_h_array2_of_p_on_curv2d.rs
// occt: Extrema_HArray2OfPOnCurv2d
...
#[derive(Clone, Debug)]
pub struct HArray2OfPOnCurv2d {
    items: Vec<Vec<POnCurv2dHandle>>,
    lower1: usize,
    lower2: usize,
}
...
impl HArray2OfPOnCurv2d {
    pub fn new(lower1: usize, upper1: usize, lower2: usize, upper2: usize) -> Self {
        ...
        let default_handle = Rc::new(RefCell::new(POnCurv2d {}));
        HArray2OfPOnCurv2d {
...
mod tests {
    ...
    fn test_harray2_creation() {
        let arr = HArray2OfPOnCurv2d::new(1, 3, 1, 2);
