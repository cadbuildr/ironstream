// FILE: step_ap214_array1_of_organization_item.rs
// occt: StepAP214_Array1OfOrganizationItem

use std::cell::RefCell;

pub struct StepAP214Array1OfOrganizationItem {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepAP214Array1OfOrganizationItem {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepAP214Array1OfOrganizationItem::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
