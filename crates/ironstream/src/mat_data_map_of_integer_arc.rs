...
pub struct MATDataMapOfIntegerArc {
    items: BTreeMap<i32, u32>,
}

impl MATDataMapOfIntegerArc {
    pub fn new() -> Self {
        Self {
            items: BTreeMap::new(),
        }
    ...
    pub fn iterator(&self) -> MATDataMapIteratorOfDataMapOfIntegerArc {
        MATDataMapIteratorOfDataMapOfIntegerArc {
...
impl Default for MATDataMapOfIntegerArc {
    fn default() -> Self {
        Self::new()
    }
}

pub struct MATDataMapIteratorOfDataMapOfIntegerArc {
    items: Vec<(i32, u32)>,
    index: usize,
}

impl MATDataMapIteratorOfDataMapOfIntegerArc {
...
mod tests {
    ...
    #[test]
    fn test_map() {
        let mut map = MATDataMapOfIntegerArc::new();
        map.bind(1, 100);
