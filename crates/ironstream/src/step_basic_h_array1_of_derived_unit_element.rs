// FILE: step_basic_h_array1_of_derived_unit_element.rs
// occt: StepBasic_HArray1OfDerivedUnitElement

use std::rc::Rc;
use std::cell::RefCell;

pub struct StepBasicHArray1OfDerivedUnitElement {
...
impl StepBasicHArray1OfDerivedUnitElement {
...
impl Clone for StepBasicHArray1OfDerivedUnitElement {
    fn clone(&self) -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicHArray1OfDerivedUnitElement::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
    ...
    #[test]
    fn test_clone() {
        let arr1 = StepBasicHArray1OfDerivedUnitElement::new(1, 3);
        arr1.set_value(2, 99);
        let arr2 = arr1.clone();
