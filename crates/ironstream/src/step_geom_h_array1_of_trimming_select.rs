// FILE: step_geom_h_array1_of_trimming_select.rs
// occt: StepGeom_HArray1OfTrimmingSelect

use std::vec::Vec;

pub struct StepGeomHArray1OfTrimmingSelect {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepGeomHArray1OfTrimmingSelect {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepGeomHArray1OfTrimmingSelect::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
