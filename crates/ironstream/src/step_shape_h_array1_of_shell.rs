// FILE: step_shape_h_array1_of_shell.rs
// occt: StepShape_HArray1OfShell

use std::vec::Vec;

pub struct StepShapeHArray1OfShell {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeHArray1OfShell {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeHArray1OfShell::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
