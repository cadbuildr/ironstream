...
/// Deprecated alias for NCollection_DataMap<int, gp_Vec2d>.
/// Maintains backward compatibility.
pub struct MAT2dDataMapOfIntegerVec2d {
    items: BTreeMap<i32, (f64, f64)>, // integer key -> gp_Vec2d (dx, dy)
}

impl MAT2dDataMapOfIntegerVec2d {
    pub fn new() -> Self {
        Self {
            items: BTreeMap::new(),
        }
    ...
    pub fn iterator(&self) -> MAT2dDataMapIteratorOfDataMapOfIntegerVec2d {
        MAT2dDataMapIteratorOfDataMapOfIntegerVec2d {
...
impl Default for MAT2dDataMapOfIntegerVec2d {
    fn default() -> Self {
        Self::new()
    }
}

/// Iterator for MAT2d_DataMapOfIntegerVec2d.
pub struct MAT2dDataMapIteratorOfDataMapOfIntegerVec2d {
    items: Vec<(i32, (f64, f64))>,
    index: usize,
}

impl MAT2dDataMapIteratorOfDataMapOfIntegerVec2d {
...
mod tests {
    ...
    fn test_map_bind_and_find() {
        let mut map = MAT2dDataMapOfIntegerVec2d::new();
        assert!(map.is_empty());
    ...
    #[test]
    fn test_default() {
        let map = MAT2dDataMapOfIntegerVec2d::default();
        assert!(map.is_empty());
    }
}
