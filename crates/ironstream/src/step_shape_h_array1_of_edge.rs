// FILE: step_shape_h_array1_of_edge.rs
// occt: StepShape_HArray1OfEdge

use std::vec::Vec;

pub struct StepShapeHArray1OfEdge {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeHArray1OfEdge {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeHArray1OfEdge::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
