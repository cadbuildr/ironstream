// FILE: step_element_h_array1_of_volume_element_purpose.rs
// occt: StepElement_HArray1OfVolumeElementPurpose

/// Rust port of OCCT's deprecated StepElement_HArray1OfVolumeElementPurpose.
/// HArray1 is a heap-allocated wrapper. A 1-based fixed-length array wrapping a Vec.
#[derive(Clone, Debug)]
pub struct StepElementHArray1OfVolumeElementPurpose {
    data: Vec<i32>,
    lower: i32,
}

impl StepElementHArray1OfVolumeElementPurpose {
...
mod tests {
    ...
    fn test_harray1_creation() {
        let arr = StepElementHArray1OfVolumeElementPurpose::new(1, 5);
    ...
    fn test_harray1_set_get() {
        let mut arr = StepElementHArray1OfVolumeElementPurpose::new(1, 3);
        arr.set_value(1, 10);
        arr.set_value(2, 20);
        arr.set_value(3, 30);
    ...
    fn test_harray1_from_vec() {
        ...
        let arr = StepElementHArray1OfVolumeElementPurpose::from_vec(1, values);
