// FILE: iges_basic_tool_single_parent.rs
// occt: IGESBasic_ToolSingleParent

/// Tool to work on a SingleParent.
pub struct IgesBasicToolSingleParent;

impl IgesBasicToolSingleParent {
    pub fn new() -> Self {
        Self
    }
    ...
    pub fn dir_checker(&self, _ent: &str) -> String {
        "SingleParent_DirChecker".to_string()
    }
    ...
    pub fn own_dump(&self, ent: &str, _dumper: &str, _own: i32) -> String {
        format!("SingleParent dump: {}", ent)
    }
}

impl Default for IgesBasicToolSingleParent {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let tool = IgesBasicToolSingleParent::new();
        assert_eq!(tool.dir_checker("test"), "SingleParent_DirChecker");
    }
}
