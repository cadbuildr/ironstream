// FILE: geom_bnd_lib_other_curve.rs
// occt: GeomBndLib_OtherCurve

/// Computes bounding box for a OtherCurve.
pub struct OtherCurve {
    data: [f64; 9],
}

impl OtherCurve {
    pub fn new(_curve: &[f64; 9]) -> Self {
        OtherCurve { data: *_curve }
    }
...
mod tests {
    ...
    #[test]
    fn test_other_curve_new() {
        let data = [0.0; 9];
        let obj = OtherCurve::new(&data);
