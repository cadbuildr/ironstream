// FILE: step_shape_h_array1_of_value_qualifier.rs
// occt: StepShape_HArray1OfValueQualifier

use std::vec::Vec;

pub struct StepShapeHArray1OfValueQualifier {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeHArray1OfValueQualifier {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeHArray1OfValueQualifier::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
