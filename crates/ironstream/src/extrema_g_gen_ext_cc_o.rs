// FILE: extrema_g_gen_ext_cc_o.rs
// occt: Extrema_GGenExtCC

/// Generic extrema solver for curve-curve.
pub struct GGenExtCC {
    done: bool,
    nb_ext: i32,
