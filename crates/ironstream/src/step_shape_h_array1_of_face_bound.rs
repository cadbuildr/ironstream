// FILE: step_shape_h_array1_of_face_bound.rs
// occt: StepShape_HArray1OfFaceBound

use std::vec::Vec;

pub struct StepShapeHArray1OfFaceBound {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeHArray1OfFaceBound {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeHArray1OfFaceBound::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
