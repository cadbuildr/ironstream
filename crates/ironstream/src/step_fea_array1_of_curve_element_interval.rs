// FILE: step_fea_array1_of_curve_element_interval.rs
// occt: StepFEA_Array1OfCurveElementInterval

/// Rust port of OCCT's deprecated StepFEA_Array1OfCurveElementInterval.
/// A 1-based fixed-length array wrapping a Vec, mimicking NCollection_Array1 semantics.
#[derive(Clone, Debug)]
pub struct StepFEAArray1OfCurveElementInterval {
    data: Vec<String>,
    lower: i32,
}

impl StepFEAArray1OfCurveElementInterval {
...
mod tests {
    ...
    fn test_array1_creation() {
        let arr = StepFEAArray1OfCurveElementInterval::new(1, 5);
    ...
    fn test_array1_access() {
        let mut arr = StepFEAArray1OfCurveElementInterval::new(1, 2);
    ...
    fn test_array1_from_vec() {
        ...
        let arr = StepFEAArray1OfCurveElementInterval::from_vec(1, values);
