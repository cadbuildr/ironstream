// FILE: t_col_std_array1_of_byte.rs
// occt: TColStd_Array1OfByte

use std::ops::Index;

/// TColStd_Array1OfByte is a deprecated alias for a 1-based array of bytes.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdArray1OfByte {
    data: Vec<u8>,
    lower: i32,
    upper: i32,
}

impl TColStdArray1OfByte {
...
impl Index<i32> for TColStdArray1OfByte {
    type Output = u8;
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdArray1OfByte::new(1, 5);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColStdArray1OfByte::new(1, 3);
        arr.set(1, 10u8);
        arr.set(2, 20u8);
        arr.set(3, 255u8);
    ...
    fn test_index_operator() {
        let mut arr = TColStdArray1OfByte::new(1, 2);
        arr.set(1, 42u8);
    ...
    fn test_out_of_bounds() {
        let arr = TColStdArray1OfByte::new(1, 3);
        let _ = arr[5];
    }
}
