// FILE: step_ap214_array1_of_auto_design_general_org_item.rs
// occt: StepAP214_Array1OfAutoDesignGeneralOrgItem

use std::cell::RefCell;

pub struct StepAP214Array1OfAutoDesignGeneralOrgItem {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepAP214Array1OfAutoDesignGeneralOrgItem {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepAP214Array1OfAutoDesignGeneralOrgItem::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
