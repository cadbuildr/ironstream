// FILE: t_col_geom_h_array1_of_surface.rs
// occt: TColGeom_HArray1OfSurface

use std::ops::Index;

/// TColGeom_HArray1OfSurface is a deprecated alias for a 1-based array of surfaces.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColGeomHArray1OfSurface {
    data: Vec<Option<String>>,
    lower: i32,
    upper: i32,
}

impl TColGeomHArray1OfSurface {
...
impl Index<i32> for TColGeomHArray1OfSurface {
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColGeomHArray1OfSurface::new(1, 5);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColGeomHArray1OfSurface::new(1, 2);
        arr.set(1, Some("plane".to_string()));
        arr.set(2, Some("sphere".to_string()));

        assert_eq!(arr.at(1), Some(&Some("plane".to_string())));
        assert_eq!(arr.at(2), Some(&Some("sphere".to_string())));
    }

    #[test]
    fn test_index_operator() {
        let mut arr = TColGeomHArray1OfSurface::new(1, 3);
        arr.set(1, Some("surf".to_string()));
        assert_eq!(arr[1], Some("surf".to_string()));
    }

    #[test]
    #[should_panic]
    fn test_out_of_bounds() {
        let arr = TColGeomHArray1OfSurface::new(1, 3);
        let _ = arr[5];
    }
}
