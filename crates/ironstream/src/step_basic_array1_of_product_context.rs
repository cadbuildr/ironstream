// FILE: step_basic_array1_of_product_context.rs
// occt: StepBasic_Array1OfProductContext

use std::cell::RefCell;

pub struct StepBasicArray1OfProductContext {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepBasicArray1OfProductContext {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicArray1OfProductContext::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
