// FILE: step_ap214_array1_of_group_item.rs
// occt: StepAP214_Array1OfGroupItem

use std::cell::RefCell;

pub struct StepAP214Array1OfGroupItem {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepAP214Array1OfGroupItem {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepAP214Array1OfGroupItem::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
