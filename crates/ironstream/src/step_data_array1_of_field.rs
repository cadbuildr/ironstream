// FILE: step_data_array1_of_field.rs
// occt: StepData_Array1OfField

use std::cell::RefCell;

pub struct StepDataArray1OfField {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepDataArray1OfField {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepDataArray1OfField::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
