// FILE: iges_basic_tool_subfigure_def.rs
// occt: IGESBasic_ToolSubfigureDef

/// Tool to work on a SubfigureDef.
pub struct IgesBasicToolSubfigureDef;

impl IgesBasicToolSubfigureDef {
    pub fn new() -> Self {
        Self
    }
    ...
    pub fn dir_checker(&self, _ent: &str) -> String {
        "SubfigureDef_DirChecker".to_string()
    }
    ...
    pub fn own_dump(&self, ent: &str, _dumper: &str, _own: i32) -> String {
        format!("SubfigureDef dump: {}", ent)
    }
}

impl Default for IgesBasicToolSubfigureDef {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let tool = IgesBasicToolSubfigureDef::new();
        assert_eq!(tool.dir_checker("test"), "SubfigureDef_DirChecker");
    }
}
