// FILE: iges_draw_array1_of_connect_point.rs
// occt: IGESDraw_Array1OfConnectPoint
...
/// Array1 of IGESDraw_ConnectPoint objects.
/// In OCCT, this was NCollection_Array1<opencascade::handle<IGESDraw_ConnectPoint>>.
/// This Rust newtype wraps a Vec with 1-indexed access for faithful behavior.
pub struct IGESDrawArray1OfConnectPoint {
    items: Vec<IGESDrawConnectPoint>,
    lower: usize,
}

impl IGESDrawArray1OfConnectPoint {
    /// Creates an array with a given lower bound and size.
    pub fn new(lower: usize, size: usize) -> Self {
        IGESDrawArray1OfConnectPoint {
...
impl Default for IGESDrawArray1OfConnectPoint {
    fn default() -> Self {
        Self::new(1, 0)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new_array() {
        let arr = IGESDrawArray1OfConnectPoint::new(1, 5);
    ...
    fn test_value_access() {
        let mut arr = IGESDrawArray1OfConnectPoint::new(1, 3);
    ...
    #[test]
    fn test_iterator() {
        let mut arr = IGESDrawArray1OfConnectPoint::new(1, 2);
