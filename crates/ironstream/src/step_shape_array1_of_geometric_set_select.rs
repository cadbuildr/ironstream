// FILE: step_shape_array1_of_geometric_set_select.rs
// occt: StepShape_Array1OfGeometricSetSelect

use std::vec::Vec;

pub struct StepShapeArray1OfGeometricSetSelect {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeArray1OfGeometricSetSelect {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeArray1OfGeometricSetSelect::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
