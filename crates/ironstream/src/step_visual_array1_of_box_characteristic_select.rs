// FILE: step_visual_array1_of_box_characteristic_select.rs
// occt: StepVisual_Array1OfBoxCharacteristicSelect

/// StepVisual_Array1OfBoxCharacteristicSelect: a 1-based array of BoxCharacteristicSelect.
///
...
impl StepVisual_Array1OfBoxCharacteristicSelect {
...
mod tests {
    ...
    fn test_array1_new_and_bounds() {
        let arr = StepVisual_Array1OfBoxCharacteristicSelect::new(1, 10);
    ...
    fn test_array1_custom_bounds() {
        let arr = StepVisual_Array1OfBoxCharacteristicSelect::new(5, 15);
    ...
    fn test_array1_at_and_set() {
        let mut arr = StepVisual_Array1OfBoxCharacteristicSelect::new(1, 5);
    ...
    fn test_array1_iterator() {
        let mut arr = StepVisual_Array1OfBoxCharacteristicSelect::new(1, 3);
        arr.set(1, 10);
        arr.set(2, 20);
        arr.set(3, 30);
    ...
    fn test_array1_empty() {
        let arr = StepVisual_Array1OfBoxCharacteristicSelect::new(1, 0);
        assert!(arr.is_empty());
        assert_eq!(arr.len(), 0);
    }
}
