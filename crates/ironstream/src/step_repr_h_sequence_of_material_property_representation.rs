// FILE: step_repr_h_sequence_of_material_property_representation.rs
// occt: StepRepr_HSequenceOfMaterialPropertyRepresentation

use std::vec::Vec;

pub struct StepReprHSequenceOfMaterialPropertyRepresentation {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepReprHSequenceOfMaterialPropertyRepresentation {
    pub fn new() -> Self {
...
impl Default for StepReprHSequenceOfMaterialPropertyRepresentation {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let mut seq = StepReprHSequenceOfMaterialPropertyRepresentation::new();
