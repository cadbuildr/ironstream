// FILE: storage_h_array_of_call_back.rs
// occt: Storage_HArrayOfCallBack

use std::sync::Arc;

#[derive(Debug, Clone)]
pub struct StorageArrayCallBack {
    lower: i32,
    upper: i32,
    data: Vec<u64>,
}

impl StorageArrayCallBack {
...
pub type Storage_HArrayOfCallBack = Arc<StorageArrayCallBack>;
...
mod tests {
    ...
    fn test_harray_bounds() {
        let arr = Arc::new(StorageArrayCallBack::new(1, 5));
    ...
    fn test_harray_shared() {
        let arr1 = Arc::new(StorageArrayCallBack::new(1, 3));
