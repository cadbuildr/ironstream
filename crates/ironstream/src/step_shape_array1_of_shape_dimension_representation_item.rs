// FILE: step_shape_array1_of_shape_dimension_representation_item.rs
// occt: StepShape_Array1OfShapeDimensionRepresentationItem

use std::vec::Vec;

pub struct StepShapeArray1OfShapeDimensionRepresentationItem {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeArray1OfShapeDimensionRepresentationItem {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeArray1OfShapeDimensionRepresentationItem::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
