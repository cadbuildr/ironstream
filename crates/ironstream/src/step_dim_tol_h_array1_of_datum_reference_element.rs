// FILE: step_dim_tol_h_array1_of_datum_reference_element.rs
// occt: StepDimTol_HArray1OfDatumReferenceElement

/// Rust port of OCCT's deprecated StepDimTol_HArray1OfDatumReferenceElement.
/// HArray1 is a heap-allocated wrapper. A 1-based fixed-length array wrapping a Vec.
#[derive(Clone, Debug)]
pub struct StepDimTolHArray1OfDatumReferenceElement {
    data: Vec<String>,
    lower: i32,
}

impl StepDimTolHArray1OfDatumReferenceElement {
...
mod tests {
    ...
    fn test_harray1_creation() {
        let arr = StepDimTolHArray1OfDatumReferenceElement::new(1, 3);
    ...
    fn test_harray1_access() {
        let mut arr = StepDimTolHArray1OfDatumReferenceElement::new(1, 2);
    ...
    fn test_harray1_from_vec() {
        ...
        let arr = StepDimTolHArray1OfDatumReferenceElement::from_vec(1, values);
