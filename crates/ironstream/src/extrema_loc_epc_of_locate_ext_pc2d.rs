// FILE: extrema_loc_epc_of_locate_ext_pc2d.rs
// occt: Extrema_LocEPCOfLocateExtPC2d

/// Type alias for 2D curve local extremum search.
pub struct ExtremaLocEpcOfLocateExtPc2d {
    done: bool,
    tol_u: f64,
    u_min: f64,
    u_sup: f64,
...
impl ExtremaLocEpcOfLocateExtPc2d {
    pub fn new() -> Self {
        ExtremaLocEpcOfLocateExtPc2d {
            done: false,
            tol_u: 0.0,
            u_min: 0.0,
            u_sup: 0.0,
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let loc = ExtremaLocEpcOfLocateExtPc2d::new();
        assert!(!loc.is_done());
    }

    #[test]
    fn test_perform() {
        let mut loc = ExtremaLocEpcOfLocateExtPc2d::new();
