// FILE: step_repr_h_array1_of_material_property_representation.rs
// occt: StepRepr_HArray1OfMaterialPropertyRepresentation

use std::vec::Vec;

pub struct StepReprHArray1OfMaterialPropertyRepresentation {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepReprHArray1OfMaterialPropertyRepresentation {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepReprHArray1OfMaterialPropertyRepresentation::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
