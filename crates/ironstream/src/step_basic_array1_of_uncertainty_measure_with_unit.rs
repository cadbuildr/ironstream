// FILE: step_basic_array1_of_uncertainty_measure_with_unit.rs
// occt: StepBasic_Array1OfUncertaintyMeasureWithUnit

use std::cell::RefCell;

pub struct StepBasicArray1OfUncertaintyMeasureWithUnit {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepBasicArray1OfUncertaintyMeasureWithUnit {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicArray1OfUncertaintyMeasureWithUnit::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
