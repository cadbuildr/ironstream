// FILE: t_col_std_h_array1_of_ascii_string.rs
// occt: TColStd_HArray1OfAsciiString

use std::ops::Index;

/// TColStd_HArray1OfAsciiString is a deprecated alias for a handle (heap-allocated) 1-based array of ASCII strings.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdHArray1OfAsciiString {
    data: Vec<String>,
    lower: i32,
    upper: i32,
}

impl TColStdHArray1OfAsciiString {
...
impl Index<i32> for TColStdHArray1OfAsciiString {
    type Output = String;
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdHArray1OfAsciiString::new(1, 5);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColStdHArray1OfAsciiString::new(1, 2);
    ...
    fn test_out_of_bounds() {
        let arr = TColStdHArray1OfAsciiString::new(1, 3);
        let _ = arr[5];
    }
}
