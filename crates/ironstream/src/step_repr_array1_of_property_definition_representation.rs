// FILE: step_repr_array1_of_property_definition_representation.rs
// occt: StepRepr_Array1OfPropertyDefinitionRepresentation

use std::vec::Vec;

pub struct StepReprArray1OfPropertyDefinitionRepresentation {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepReprArray1OfPropertyDefinitionRepresentation {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepReprArray1OfPropertyDefinitionRepresentation::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
