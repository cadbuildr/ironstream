// FILE: t_col_std_array1_of_extended_string.rs
// occt: TColStd_Array1OfExtendedString

use std::ops::Index;

/// TColStd_Array1OfExtendedString is a deprecated alias for a 1-based array of extended strings.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdArray1OfExtendedString {
    data: Vec<String>,
    lower: i32,
    upper: i32,
}

impl TColStdArray1OfExtendedString {
...
impl Index<i32> for TColStdArray1OfExtendedString {
    type Output = String;
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdArray1OfExtendedString::new(1, 5);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColStdArray1OfExtendedString::new(1, 2);
    ...
    fn test_out_of_bounds() {
        let arr = TColStdArray1OfExtendedString::new(1, 3);
        let _ = arr[5];
    }
}
