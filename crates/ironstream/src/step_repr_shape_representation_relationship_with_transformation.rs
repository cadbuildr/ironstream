// FILE: step_repr_shape_representation_relationship_with_transformation.rs
// occt: StepRepr_ShapeRepresentationRelationshipWithTransformation
...
/// Represents a shape representation relationship with an associated transformation.
...
impl ShapeRepresentationRelationshipWithTransformation {
    /// Create a new ShapeRepresentationRelationshipWithTransformation
    pub fn new() -> Self {
        ShapeRepresentationRelationshipWithTransformation {
            name: None,
            description: None,
            rep1: None,
            rep2: None,
...
impl Default for ShapeRepresentationRelationshipWithTransformation {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn test_create_default() {
        let rel = ShapeRepresentationRelationshipWithTransformation::new();
    ...
    #[test]
    fn test_init() {
        let mut rel = ShapeRepresentationRelationshipWithTransformation::new();
