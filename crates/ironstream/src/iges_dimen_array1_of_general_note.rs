// FILE: iges_dimen_array1_of_general_note.rs
// occt: IGESDimen_Array1OfGeneralNote
...
/// Array1 of IGESDimen_GeneralNote objects.
/// In OCCT, this was NCollection_Array1<opencascade::handle<IGESDimen_GeneralNote>>.
/// This Rust newtype wraps a Vec with 1-indexed access for faithful behavior.
pub struct IGESDimenArray1OfGeneralNote {
    items: Vec<IGESDimenGeneralNote>,
    lower: usize,
}

impl IGESDimenArray1OfGeneralNote {
    /// Creates an array with a given lower bound and size.
    pub fn new(lower: usize, size: usize) -> Self {
        IGESDimenArray1OfGeneralNote {
...
impl Default for IGESDimenArray1OfGeneralNote {
    fn default() -> Self {
        Self::new(1, 0)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new_array() {
        let arr = IGESDimenArray1OfGeneralNote::new(1, 5);
    ...
    fn test_value_access() {
        let mut arr = IGESDimenArray1OfGeneralNote::new(1, 3);
    ...
    #[test]
    fn test_iterator() {
        let mut arr = IGESDimenArray1OfGeneralNote::new(1, 2);
