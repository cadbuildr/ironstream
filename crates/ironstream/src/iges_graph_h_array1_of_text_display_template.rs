// FILE: iges_graph_h_array1_of_text_display_template.rs
// occt: IGESGraph_HArray1OfTextDisplayTemplate
...
/// Handle-based Array1 of IGESGraph_TextDisplayTemplate objects.
/// In OCCT, this was NCollection_HArray1<opencascade::handle<IGESGraph_TextDisplayTemplate>>.
/// This Rust newtype wraps a Vec with 1-indexed access for faithful handle semantics.
pub struct IGESGraphHArray1OfTextDisplayTemplate {
    items: Vec<IGESGraphTextDisplayTemplate>,
    lower: usize,
}

impl IGESGraphHArray1OfTextDisplayTemplate {
...
impl Default for IGESGraphHArray1OfTextDisplayTemplate {
    fn default() -> Self {
        Self::new(1, 0)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new_array() {
        let arr = IGESGraphHArray1OfTextDisplayTemplate::new(1, 5);
    ...
    fn test_value_access() {
        let mut arr = IGESGraphHArray1OfTextDisplayTemplate::new(1, 3);
    ...
    #[test]
    fn test_iterator() {
        let mut arr = IGESGraphHArray1OfTextDisplayTemplate::new(1, 2);
