// FILE: step_shape_h_array1_of_geometric_set_select.rs
// occt: StepShape_HArray1OfGeometricSetSelect

use std::vec::Vec;

pub struct StepShapeHArray1OfGeometricSetSelect {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeHArray1OfGeometricSetSelect {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeHArray1OfGeometricSetSelect::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
