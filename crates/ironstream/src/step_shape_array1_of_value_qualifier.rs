// FILE: step_shape_array1_of_value_qualifier.rs
// occt: StepShape_Array1OfValueQualifier

use std::vec::Vec;

pub struct StepShapeArray1OfValueQualifier {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeArray1OfValueQualifier {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeArray1OfValueQualifier::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
