// FILE: step_ap214_array1_of_auto_design_date_and_person_item.rs
// occt: StepAP214_Array1OfAutoDesignDateAndPersonItem

use std::cell::RefCell;

/// Deprecated newtype: a 1-based Array1 of StepAP214_AutoDesignDateAndPersonItem.
/// Mirrors OCCT NCollection_Array1<StepAP214_AutoDesignDateAndPersonItem>.
/// Uses Lower/Upper bounds (1-based indexing by default, like OCCT Array1).
pub struct StepAP214Array1OfAutoDesignDateAndPersonItem {
    data: RefCell<Vec<i32>>, // Placeholder for StepAP214_AutoDesignDateAndPersonItem
    lower: usize,
    upper: usize,
}

impl StepAP214Array1OfAutoDesignDateAndPersonItem {
...
mod tests {
    ...
    fn test_array1_create() {
        let arr = StepAP214Array1OfAutoDesignDateAndPersonItem::new(1, 10);
    ...
    fn test_array1_bounds() {
        let arr = StepAP214Array1OfAutoDesignDateAndPersonItem::new(5, 15);
    ...
    fn test_array1_get_set() {
        let arr = StepAP214Array1OfAutoDesignDateAndPersonItem::new(1, 5);
        arr.set_value(1, 100);
        arr.set_value(3, 200);
        arr.set_value(5, 300);
    ...
    fn test_array1_panic_lower() {
        let arr = StepAP214Array1OfAutoDesignDateAndPersonItem::new(5, 10);
