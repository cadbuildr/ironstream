...
/// Local mirror of the StepBasic_ProductDefinitionOrReference select type
/// (AP242): may hold a ProductDefinition, a ProductDefinitionReference, or a
/// ProductDefinitionReferenceWithLocalRepresentation. Unset when empty.
