// FILE: step_repr_h_array1_of_shape_aspect.rs
// occt: StepRepr_HArray1OfShapeAspect

use std::vec::Vec;

pub struct StepReprHArray1OfShapeAspect {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepReprHArray1OfShapeAspect {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepReprHArray1OfShapeAspect::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
