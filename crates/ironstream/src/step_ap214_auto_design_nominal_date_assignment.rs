// FILE: step_ap214_auto_design_nominal_date_assignment.rs
// occt: StepAP214_AutoDesignNominalDateAssignment

#[derive(Clone, Debug)]
pub struct AutoDesignDatedItem {}

#[derive(Clone, Debug)]
pub struct AutoDesignNominalDateAssignment {
...
impl Default for AutoDesignNominalDateAssignment {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let assignment = AutoDesignNominalDateAssignment::new();
        assert_eq!(assignment.nb_items(), 0);
    }

    #[test]
    fn test_set_items() {
        let mut assignment = AutoDesignNominalDateAssignment::new();
