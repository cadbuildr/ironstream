// FILE: step_shape_h_array1_of_oriented_closed_shell.rs
// occt: StepShape_HArray1OfOrientedClosedShell

use std::vec::Vec;

pub struct StepShapeHArray1OfOrientedClosedShell {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeHArray1OfOrientedClosedShell {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeHArray1OfOrientedClosedShell::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
