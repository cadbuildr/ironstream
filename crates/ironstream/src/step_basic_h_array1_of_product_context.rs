// FILE: step_basic_h_array1_of_product_context.rs
// occt: StepBasic_HArray1OfProductContext

use std::rc::Rc;
use std::cell::RefCell;

pub struct StepBasicHArray1OfProductContext {
...
impl StepBasicHArray1OfProductContext {
...
impl Clone for StepBasicHArray1OfProductContext {
    fn clone(&self) -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicHArray1OfProductContext::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
    ...
    #[test]
    fn test_clone() {
        let arr1 = StepBasicHArray1OfProductContext::new(1, 3);
        arr1.set_value(2, 99);
        let arr2 = arr1.clone();
