...
pub struct MATDataMapOfIntegerBisector {
    items: BTreeMap<i32, u32>,
}

impl MATDataMapOfIntegerBisector {
    pub fn new() -> Self {
        Self {
            items: BTreeMap::new(),
        }
    ...
    pub fn iterator(&self) -> MATDataMapIteratorOfDataMapOfIntegerBisector {
        MATDataMapIteratorOfDataMapOfIntegerBisector {
...
impl Default for MATDataMapOfIntegerBisector {
    fn default() -> Self {
        Self::new()
    }
}

pub struct MATDataMapIteratorOfDataMapOfIntegerBisector {
    items: Vec<(i32, u32)>,
    index: usize,
}

impl MATDataMapIteratorOfDataMapOfIntegerBisector {
...
mod tests {
    ...
    #[test]
    fn test_map() {
        let mut map = MATDataMapOfIntegerBisector::new();
        map.bind(1, 100);
