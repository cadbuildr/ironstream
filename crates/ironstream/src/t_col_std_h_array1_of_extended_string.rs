// FILE: t_col_std_h_array1_of_extended_string.rs
// occt: TColStd_HArray1OfExtendedString

use std::ops::Index;

/// TColStd_HArray1OfExtendedString is a deprecated alias for a handle (heap-allocated) 1-based array of extended strings.
/// This is a Rust port implementing OCCT's 1-based indexing semantics.
pub struct TColStdHArray1OfExtendedString {
    data: Vec<String>,
    lower: i32,
    upper: i32,
}

impl TColStdHArray1OfExtendedString {
    ...
    pub fn new(lower: i32, upper: i32) -> Self {
        ...
        TColStdHArray1OfExtendedString {
...
impl Index<i32> for TColStdHArray1OfExtendedString {
    type Output = String;
...
mod tests {
    ...
    fn test_creation_and_bounds() {
        let arr = TColStdHArray1OfExtendedString::new(1, 5);
    ...
    #[test]
    fn test_set_and_get() {
        let mut arr = TColStdHArray1OfExtendedString::new(1, 2);
        arr.set(1, "unicode".to_string());
        arr.set(2, "text".to_string());

        assert_eq!(arr.at(1), Some(&"unicode".to_string()));
        assert_eq!(arr.at(2), Some(&"text".to_string()));
    }

    #[test]
    fn test_index_operator() {
        let mut arr = TColStdHArray1OfExtendedString::new(1, 2);
        arr.set(1, "extended".to_string());
        assert_eq!(arr[1], "extended".to_string());
    }

    #[test]
    #[should_panic]
    fn test_out_of_bounds() {
        let arr = TColStdHArray1OfExtendedString::new(1, 3);
        let _ = arr[5];
    }
}
