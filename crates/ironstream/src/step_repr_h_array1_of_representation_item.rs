// FILE: step_repr_h_array1_of_representation_item.rs
// occt: StepRepr_HArray1OfRepresentationItem

use std::vec::Vec;

pub struct StepReprHArray1OfRepresentationItem {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepReprHArray1OfRepresentationItem {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepReprHArray1OfRepresentationItem::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
