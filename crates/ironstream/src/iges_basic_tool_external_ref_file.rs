// FILE: iges_basic_tool_external_ref_file.rs
// occt: IGESBasic_ToolExternalRefFile

/// Tool to work on an ExternalRefFile.
pub struct IgesBasicToolExternalRefFile;

impl IgesBasicToolExternalRefFile {
    pub fn new() -> Self {
        Self
    }
    ...
    pub fn dir_checker(&self, _ent: &str) -> String {
        "ExternalRefFile_DirChecker".to_string()
    }
    ...
    pub fn own_dump(&self, ent: &str, _dumper: &str, _own: i32) -> String {
        format!("ExternalRefFile dump: {}", ent)
    }
}

impl Default for IgesBasicToolExternalRefFile {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let tool = IgesBasicToolExternalRefFile::new();
        assert_eq!(tool.dir_checker("test"), "ExternalRefFile_DirChecker");
    }
