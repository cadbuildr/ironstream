// FILE: step_basic_array1_of_person.rs
// occt: StepBasic_Array1OfPerson

use std::cell::RefCell;

pub struct StepBasicArray1OfPerson {
    data: RefCell<Vec<i32>>,
    lower: usize,
    upper: usize,
}

impl StepBasicArray1OfPerson {
...
mod tests {
    ...
    #[test]
    fn test_basics() {
        let arr = StepBasicArray1OfPerson::new(1, 5);
        assert_eq!(arr.len(), 5);
        arr.set_value(2, 42);
