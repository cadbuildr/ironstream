// FILE: t_col_std_h_sequence_of_ascii_string.rs
// occt: TColStd_HSequenceOfAsciiString

/// TColStd_HSequenceOfAsciiString is a deprecated alias for a handle (heap-allocated) sequence of ASCII strings.
/// This is a Rust port implementing OCCT's sequence semantics (1-based indexing).
pub struct TColStdHSequenceOfAsciiString {
    data: Vec<String>,
}

impl TColStdHSequenceOfAsciiString {
    /// Creates a new empty sequence.
    pub fn new() -> Self {
        TColStdHSequenceOfAsciiString {
            data: Vec::new(),
        }
    }
...
impl Default for TColStdHSequenceOfAsciiString {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn test_append_and_length() {
        let mut seq = TColStdHSequenceOfAsciiString::new();
    ...
    fn test_set() {
        ...
        seq.set(1, "new".to_string());

        assert_eq!(seq.at(1), Some(&"new".to_string()));
    }
