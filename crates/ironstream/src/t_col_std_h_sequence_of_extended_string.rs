// FILE: t_col_std_h_sequence_of_extended_string.rs
// occt: TColStd_HSequenceOfExtendedString

/// TColStd_HSequenceOfExtendedString is a deprecated alias for a handle (heap-allocated) sequence of extended strings.
/// This is a Rust port implementing OCCT's sequence semantics (1-based indexing).
pub struct TColStdHSequenceOfExtendedString {
    data: Vec<String>,
}

impl TColStdHSequenceOfExtendedString {
...
impl Default for TColStdHSequenceOfExtendedString {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn test_append_and_length() {
        let mut seq = TColStdHSequenceOfExtendedString::new();
    ...
    fn test_insert_before() {
        ...
        assert_eq!(seq.at(1), Some(&"a".to_string()));
        assert_eq!(seq.at(2), Some(&"b".to_string()));
        assert_eq!(seq.at(3), Some(&"c".to_string()));
    }
