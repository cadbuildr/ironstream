// FILE: step_shape_array1_of_shell.rs
// occt: StepShape_Array1OfShell

use std::vec::Vec;

pub struct StepShapeArray1OfShell {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeArray1OfShell {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeArray1OfShell::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
