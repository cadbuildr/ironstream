// FILE: step_geom_h_array1_of_pcurve_or_surface.rs
// occt: StepGeom_HArray1OfPcurveOrSurface

use std::vec::Vec;

pub struct StepGeomHArray1OfPcurveOrSurface {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepGeomHArray1OfPcurveOrSurface {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepGeomHArray1OfPcurveOrSurface::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
