...
pub struct MATDataMapOfIntegerNode {
    items: BTreeMap<i32, u32>,
}

impl MATDataMapOfIntegerNode {
    pub fn new() -> Self {
        Self {
            items: BTreeMap::new(),
        }
    ...
    pub fn iterator(&self) -> MATDataMapIteratorOfDataMapOfIntegerNode {
        MATDataMapIteratorOfDataMapOfIntegerNode {
...
impl Default for MATDataMapOfIntegerNode {
    fn default() -> Self {
        Self::new()
    }
}

pub struct MATDataMapIteratorOfDataMapOfIntegerNode {
    items: Vec<(i32, u32)>,
    index: usize,
}

impl MATDataMapIteratorOfDataMapOfIntegerNode {
...
mod tests {
    ...
    #[test]
    fn test_map() {
        let mut map = MATDataMapOfIntegerNode::new();
        map.bind(1, 100);
