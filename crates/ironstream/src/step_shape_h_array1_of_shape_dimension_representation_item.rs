// FILE: step_shape_h_array1_of_shape_dimension_representation_item.rs
// occt: StepShape_HArray1OfShapeDimensionRepresentationItem

use std::vec::Vec;

pub struct StepShapeHArray1OfShapeDimensionRepresentationItem {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeHArray1OfShapeDimensionRepresentationItem {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeHArray1OfShapeDimensionRepresentationItem::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
