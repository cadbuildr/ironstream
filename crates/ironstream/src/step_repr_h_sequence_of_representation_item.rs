// FILE: step_repr_h_sequence_of_representation_item.rs
// occt: StepRepr_HSequenceOfRepresentationItem

use std::vec::Vec;

pub struct StepReprHSequenceOfRepresentationItem {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepReprHSequenceOfRepresentationItem {
    pub fn new() -> Self {
...
impl Default for StepReprHSequenceOfRepresentationItem {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let mut seq = StepReprHSequenceOfRepresentationItem::new();
