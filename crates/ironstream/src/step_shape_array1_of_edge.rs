// FILE: step_shape_array1_of_edge.rs
// occt: StepShape_Array1OfEdge

use std::vec::Vec;

pub struct StepShapeArray1OfEdge {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeArray1OfEdge {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeArray1OfEdge::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
