// FILE: iges_basic_tool_hierarchy.rs
// occt: IGESBasic_ToolHierarchy

/// Tool to work on a Hierarchy.
pub struct IgesBasicToolHierarchy;

impl IgesBasicToolHierarchy {
    pub fn new() -> Self {
        Self
    }
    ...
    pub fn dir_checker(&self, _ent: &str) -> String {
        "Hierarchy_DirChecker".to_string()
    }
    ...
    pub fn own_dump(&self, ent: &str, _dumper: &str, _own: i32) -> String {
        format!("Hierarchy dump: {}", ent)
    }
}

impl Default for IgesBasicToolHierarchy {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let tool = IgesBasicToolHierarchy::new();
        assert_eq!(tool.dir_checker("test"), "Hierarchy_DirChecker");
    }
}
