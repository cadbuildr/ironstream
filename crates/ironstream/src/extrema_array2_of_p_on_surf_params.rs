// FILE: extrema_array2_of_p_on_surf_params.rs
// occt: Extrema_Array2OfPOnSurfParams

#[derive(Clone, Debug)]
pub struct POnSurfParams {}

#[derive(Clone, Debug)]
pub struct Array2OfPOnSurfParams {
    items: Vec<Vec<POnSurfParams>>,
    lower1: usize,
    lower2: usize,
}

impl Array2OfPOnSurfParams {
    pub fn new(lower1: usize, upper1: usize, lower2: usize, upper2: usize) -> Self {
        ...
        Array2OfPOnSurfParams {
            items: vec![vec![POnSurfParams {}; size2]; size1],
            lower1,
            lower2,
        }
    }

    pub fn at(&self, i: usize, j: usize) -> Option<&POnSurfParams> {
        let i_idx = i.checked_sub(self.lower1)?;
        let j_idx = j.checked_sub(self.lower2)?;
        self.items.get(i_idx)?.get(j_idx)
    }

    pub fn set(&mut self, i: usize, j: usize, val: POnSurfParams) -> bool {
...
mod tests {
    ...
    fn test_array2_creation() {
        let arr = Array2OfPOnSurfParams::new(1, 3, 1, 2);
