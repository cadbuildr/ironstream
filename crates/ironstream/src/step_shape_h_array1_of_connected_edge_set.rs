// FILE: step_shape_h_array1_of_connected_edge_set.rs
// occt: StepShape_HArray1OfConnectedEdgeSet

use std::vec::Vec;

pub struct StepShapeHArray1OfConnectedEdgeSet {
    data: Vec<Option<String>>,
    lower: usize,
}

impl StepShapeHArray1OfConnectedEdgeSet {
...
mod tests {
    ...
    #[test]
    fn test_basic() {
        let arr = StepShapeHArray1OfConnectedEdgeSet::new(1, 3);
        assert_eq!(arr.len(), 3);
    }
}
